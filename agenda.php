...
$edicion=array();
  ...
  mysql_free_result($resultado);
     ...
     $SQLquery = "SELECT n.*  FROM noticia as n
	 				inner join categoria as c on n.rubro=c.id_cat WHERE c.categoria_cat='Agenda' and  n.fecha='".$edicion["fecha"][0]."' order by relevancia, orden, id_noticia"; 
     $resultado= mysql_query($SQLquery,$base)or die(mysql_error()); 
     if (mysql_num_rows($resultado)>0)
     {
		 $i=0;
