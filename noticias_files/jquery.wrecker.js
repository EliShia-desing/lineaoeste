...
$.Wrecker = function()
{
	...
	function updateGrid()
	{
		...
		element.children("div.dynamic-group").children().unwrap();
		...
		if (columnCount > 1)
		{
			...
			cells.each(function(i)
			{
				...
				{
					cells.slice(startIndex,i+1).wrapAll('<div class="dynamic-group '+ settings.elWidth +'"/>');
