...
stm_ai("p0i<?php echo $i;?>0",[0,"<?php echo $i+1;?> ","","",-1,-1,0,"eliminar_noticia.php?tipo=<?php echo $tipo;?>&pactual=<?php echo $i; ?>","_self","","","","",0,0,0,"","",0,0,0,0,1,"#DBDDD2",0,"#FFFFFF",0,"","",3,3,2,3,"#000000 #000000 #AAD63E","#000000 #000000 #AAD63E","#333333","#000000","bold 8pt Verdana","bold 8pt Verdana",0,0]);
<?php
}
?>
stm_ep();
		...
		<table width="962" border="0" align="center" cellpadding="0" cellspacing="3" >
		  ...
		  <tr>
            ...
            <td width="58" bgcolor="#B4B4B4" align="center">
				<a href="eliminar_noticia2.php?tipo=<?php echo $tipo;?>&id=<?php echo $regi["id"];?>" >
