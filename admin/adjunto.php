...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
  <tr>
    <td width="800" colspan="2" align="left">
		<form action="adjunto.php" method="post" enctype="multipart/form-data">
...
<td colspan="2">&nbsp;  
	  ...
	  <form action="adjunto.php?id=<?php echo $idNoticia;?>" method="post" enctype="multipart/form-data">
	...
	<TR>
		...
		<textarea name="descripcion2" cols="48" rows="3"><?php echo $datos["descripcion"];  ?></textarea>
