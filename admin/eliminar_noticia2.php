...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F4F4F4">
  <tr>
    <td width="800" align="left"><span class="Estilo2">Eliminar Noticia </span></td>
  </tr>
  <tr>
...
stm_ai("p0i<?php echo $i;?>0",[0,"<?php echo $i+1;?> ","","",-1,-1,0,"eliminar_noticia2.php?tipo=<?php echo $tipo;?>&pactual=<?php echo $i; ?>&id=<?php echo $id; ?>","_self","","","","",0,0,0,"","",0,0,0,0,1,"#DBDDD2",0,"#FFFFFF",0,"","",3,3,2,3,"#000000 #000000 #AAD63E","#000000 #000000 #AAD63E","#333333","#000000","bold 8pt Verdana","bold 8pt Verdana",0,0]);
<?php
}
?>
stm_ep();
		...
		<table width="953" border="0" align="center" cellpadding="0" cellspacing="3" >
		  ...
		  <tr>
            ...
            <td width="145" bgcolor="#B4B4B4" align="center">
				<a href="#" onclick="return(elimina(<?php echo $regi["id_noticia"];?>))" >
					Eliminar
					</a>					</td>
          </tr>
		  <?php }?>
