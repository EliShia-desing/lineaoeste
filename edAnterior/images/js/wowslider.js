...
(function($){
	...
	var effectsPath = '/edAnterior/images/efects/';
			...
			if(/laptop|tablet|mobile/g.test(thisClass)) {
				...
				if(/laptop/g.test(thisClass)) {
					sliderCont.css('maxWidth', sliderCont.width()).animate({
						maxWidth: curResponsive>1?$(window).width():640
					}, resizeWnd);
		...
		*/
		...
		if(!firstInitBtns) {
			...
			if(wow.attr('data-fullscreen')) {
				wow.parent().css('max-width', '640px');
			}
