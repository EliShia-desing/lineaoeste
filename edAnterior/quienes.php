 	...
 	<div id="contenido" class="row">
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
				<div id="portada" class="row">
					<h1>
						<a href="#">Linea Oeste </a>
					</h1>						
					<br /><br />
					<div align="center" >
					<span style="color: #4C1880; font-weight: bold;">DIRECTORA PROPIETARIA</span><br />
Nora B. Mestre<br /><br />

Pasaje el Trébol 6947 Cap. Fed. (1408) <br />
Tel. 4641-0997 <br />
Email: lineaoeste@yahoo.com.ar<br />
REGISTRO DE LA PROPIEDAD INTELECTUAL: 5245779
					</div>		
				</div>
			</div>
