...
$edicion=array();
  ...
  mysqli_free_result($resultado);
     ...
     $SQLquery = "SELECT *  FROM noticia  WHERE  fecha='".$edicion["fecha"][0]."' order by relevancia, orden, id_noticia"; 
   $resultado= mysqli_query($base,$SQLquery)or die(mysqli_error()); 
			...
			<div id="ver_seccion" class="row">
			 ...
			 <?php 
			  ...
			  ?>
					...
					<div class="nota_h">
                   		<h3><a href="noticia.php?id=<?php echo $noticiaP[$m]["id"];?>&edicion=<?php echo $idEdicion;?>"><?php echo utf8_encode($noticiaP[$m]["titulo"]);?></a></h3>
					...
					<div class="nota_h">
                   		<a href="noticia.php?id=<?php echo $noticiaP[$m]["id"];?>&edicion=<?php echo $idEdicion;?>">
