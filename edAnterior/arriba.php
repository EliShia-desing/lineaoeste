	...
	<body>
      <div id="menu_superior">
          ...
          <div class="pull-right">
				...
				<a href="agenda.php?edicion=<?php echo $idEdicion; ?>" target="_blank" class="hidden-xs">&gt; Agenda</a>
    ...
    <div class="collapse navbar-collapse navbar-menubuilder">
        <div class="container">
            <ul class="nav navbar-nav navbar-left">
				...
				<li class="<?php echo $menuActivo;  ?>">
				   <a href="noticias.php?edicion=<?php echo $idEdicion; ?>">Noticias</a></li>
				
				<?php if($contadorVisita=="Agenda") {$menuActivo="active";}
			      else $menuActivo="";?>	   
				<li class="<?php echo $menuActivo;  ?>">
				   <a href="agenda.php?edicion=<?php echo $idEdicion; ?>">Agenda</a></li>
				<?php if($contadorVisita=="Arte") {$menuActivo="active";}
			      else $menuActivo="";?>	   
				<li class="<?php echo $menuActivo;  ?>">
				   <a href="arte.php?edicion=<?php echo $idEdicion; ?>">Arte y Cultura</a></li>
